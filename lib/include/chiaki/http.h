...
CHIAKI_EXPORT ChiakiErrorCode chiaki_recv_http_header_psn(ChiakiRudp rudp, ChiakiLog *log, 
	uint16_t local_counter, uint16_t *remote_counter, char *buf, size_t buf_size, 
