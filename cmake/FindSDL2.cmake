...
if(PkgConfig_FOUND)
    pkg_search_module(PC_SDL2 QUIET IMPORTED_TARGET sdl2-compat sdl2)
endif()

if(PC_SDL2_FOUND)
    set(SDL2_FOUND TRUE)
    set(SDL2_INCLUDE_DIRS "${PC_SDL2_INCLUDE_DIRS}")
    set(SDL2_INCLUDE_DIR "${PC_SDL2_INCLUDEDIR}")
    set(SDL2_LIBRARIES "${PC_SDL2_LINK_LIBRARIES}")
    set(SDL2_LIBDIR "${PC_SDL2_LIBRARY_DIRS}")
    set(SDL2_VERSION "${PC_SDL2_VERSION}")

    if(SDL2_VERSION MATCHES "^([0-9]+)\.([0-9]+)\.([0-9]+)")
        set(SDL2_VERSION_MAJOR "${CMAKE_MATCH_1}")
        set(SDL2_VERSION_MINOR "${CMAKE_MATCH_2}")
        set(SDL2_VERSION_PATCH "${CMAKE_MATCH_3}")
    endif()

    if(NOT TARGET SDL2::SDL2)
        add_library(SDL2::SDL2 INTERFACE IMPORTED GLOBAL)
        set_target_properties(SDL2::SDL2 PROPERTIES
                INTERFACE_LINK_LIBRARIES PkgConfig::PC_SDL2
    ...
    if(NOT SDL2_INCLUDE_DIR AND SDL2_INCLUDE_DIRS)
...
find_package_handle_standard_args(SDL2 REQUIRED_VARS SDL2_FOUND VERSION_VAR SDL2_VERSION)
